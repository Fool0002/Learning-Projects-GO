...
func main(){
	...
	rand.Seed(time.Now().UnixNano())
		...
		for {
			...
			switch choice {
			case 1: fmt.Println("A random number between 1-100 is selected. Place your guesss.")
			...
			case 2: fmt.Println("A random number between 1-100 is selected. Place your guesss within the time limit. ")
					for {
